...
export default function ConsultationForm() {
	...
	return (
		<section id="consultation"
			...
			<p className="mt-[10px] mb-[40px] md:mt-[40px] md:mb-[33px] xl:mt-[20px] xl:mb-[60px] text-[12px] md:text-[16px] font-inter font-light text-center whitespace-pre-line text-white">
				{ t('subtitle') }
			</p>
			...
			<div className="grid grid-cols-2 md:grid-cols-3 gap-x-[60px] gap-y-[20px]">
				<ContactItem
					icon={ <PhoneIcon/> }
